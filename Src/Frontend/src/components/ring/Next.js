                ...
                <div className="col-md-6 col-sm-12 what-next-text-container">
                    <div>
                        ...
                        <div style={{ color: "rgb(160, 174, 192)" }}>While sitting back, relaxing, and waiting for the
                            ...
                            different ways you can be involved with the PET community below!</div>
                    </div>
                    <div>
                        <div className="text-blue small-title">SHARE YOUR NODE STATS ON TWITTER</div>
                        <div>Share your PET-nest stats on Twitter and let the community know you’re part of the
                            PET Network! By doing so, you will automatically be entered into a draw to receive 5
                            PET tokens. <br /><span className="text-blue link-underline">Share on Twitter.</span></div>
                    </div>
                    <div>
                        ...
                        <div>Join thousands of community members on Discord where they are helping shape the future
                            of the PET Network. <br /><span className="text-purple link-underline">Join PET
                                Discord.</span></div>
                    </div>
                    <div>
                        <div className="text-pink small-title">REPORT A BUG WITH THE WEBSITE</div>
                        <div>Help make PET better by reporting any issues you’ve found with the website or dApp.
                            This is also the place to report any security disclosures. <br /><a
                                href="mailto:help@info@peacetokenfinance.in" className="text-pink link-underline">Report a bug.</a>
                        </div>
                    </div>
                </div>
