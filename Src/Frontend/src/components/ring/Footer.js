            ...
            <div className="custom-container mx-auto">
                <div>
                    <div id="footer-brand" className="f-row f2-center gap-2" style={{fontSize: "larger"}}>
                        ...
                        <span id="brand-name">PET</span>
                    </div>
                    <span id="copyright">© 2021 Copyright PET.financial</span>
                </div>
                <div id="links">
                    <div id="links">
                        <a href="/">Main</a> |
                ...
                <div id="links">
                    <a href="https://twitter.com/peace_tokenfin">Twitter</a> |
                    {/* <a href="https://t.me/ring_financial">Telegram</a> | */}
                    <a href="https://discord.gg/9Ms9zwfG">Discord</a>
                </div>
            </div>
        </footer>
    );
