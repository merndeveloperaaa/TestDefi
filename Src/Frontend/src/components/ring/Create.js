        ...
        return (
            <div className="custom-container mx-auto text-justify info-container"
                ...
                <div className="create_title">
                    Create a Node with 10 PET Tokens
                </div>
                <p id="create-ring">Create a Peace Node with <strong>1,000,000</strong>
                    <span className="sc-gsTEea cdmEaM">$PET</span> tokens to earn <span className="sc-gsTEea cdmEaM">$PET</span>
                    token rewards.<br />Current estimated rewards:<strong> 2,000</strong> <span
                        className="sc-gsTEea cdmEaM">$PET</span>/day.
                </p>
                <div className="container flex justify-center mt-4"><button className="white-btn btn" style={{padding: '25px 40px', fontSize: '20px'}} onClick={this.createNode}>CREATE A NEST</button>
                </div>
                <Modal
                        ...
                        <div className="modal-body c-w">
                            <div className="row justify-content-center">
                                <div className="col-8 text-center" style={{ lineHeight: "1.75" }}>Start earning lifetime high-yield <span
                                    ...
                                    including the number of nodes, nest revenue, token price, and protocol revenue, and they are variable.</div>
                            </div>
